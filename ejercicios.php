            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box iconbox-blue">
                        ...
                        <h4><a href="">Be Going To</a></h4>
                        <p>Aprende este tiempo verbal con nosotros !</p><br>
                        <a href="explgoing.php"><button type="button" class="btn btn-primary text-white">Vamos!</button></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box iconbox-orange ">
                        ...
                        <p>Aprende a usar este verbo primordial con nosotros !</p><br>
                        <a href="explbe.php"><button type="button" class="btn btn-primary text-white">Vamos!</button></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box iconbox-pink">
                        ...
                        <h4><a href="">Present Continous</a></h4>
                        <p>Aprende a usar este tiempo verbal con nosotros !</p><br>
                        <a href="explprescont.php"><button type="button" class="btn btn-primary text-white">Vamos!</button></a>
                    </div>
                </div>
            </div>
        </div>
